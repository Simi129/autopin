    ...
    <section id="pricing" className="relative max-w-6xl mx-auto px-6 py-20 overflow-hidden">
          ...
          <div className="relative p-12 md:p-16">
            ...
            <div className="grid md:grid-cols-2 gap-4 mb-10">
              {[
                ...
                <div 
                  key={idx}
                  className="flex items-center gap-3 p-4 rounded-xl bg-white/50 backdrop-blur-sm border border-white/60 hover:border-rose-200 transition-all group"
                >
            ...
            <div className="flex items-center justify-center gap-3 mb-8 p-4 rounded-2xl bg-gradient-to-r from-rose-50 to-orange-50 border border-rose-100">
              ...
              <span className="text-slate-700 font-medium">
                Free access ends in{' '}
                <span className="text-rose-600 font-bold">25 days</span>
              </span>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-sm text-slate-500 mt-6">
                No payment required • Full access • No obligations
              </p>
            </div>
            ...
            <div className="mt-10 pt-8 border-t border-slate-200/50">
              <div className="flex items-center justify-center gap-8 text-center">
                <div>
                  ...
                  <div className="text-xs text-slate-500 uppercase tracking-wide">Early Users</div>
                </div>
                <div className="w-px h-12 bg-slate-200"></div>
                <div>
                  <div className="text-2xl font-bold text-slate-900 mb-1">50K+</div>
                  <div className="text-xs text-slate-500 uppercase tracking-wide">Pins Scheduled</div>
                </div>
                <div className="w-px h-12 bg-slate-200"></div>
                <div>
                  <div className="text-2xl font-bold text-slate-900 mb-1">4.9★</div>
                  <div className="text-xs text-slate-500 uppercase tracking-wide">Beta Rating</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <div className="mt-12 text-center">
        ...
        <div className="flex items-center justify-center gap-8 opacity-40 grayscale">
          <div className="text-slate-400 font-semibold">Pinterest</div>
          <div className="text-slate-400 font-semibold">Etsy</div>
